...
"""
1. Setup & Display the Dino
2. Create Playable Game
3. Add A.I. to Game
...
class Cactus:
    def __init__(self, img, no_of_cacti):
        self.image = img
        self.type = no_of_cacti
...
class SmallCactus(Cactus):
    def __init__(self, image, no_of_cacti):
        super().__init__(image, no_of_cacti)
        self.rect.y = 325
...
def eval_genomes(genomes, config):
    ...
    def score():
        ...
        if points % 100 == 0:
            game_speed += 1
        text = FONT.render(f"Score: {str(points)}", True, (50, 50, 50))
